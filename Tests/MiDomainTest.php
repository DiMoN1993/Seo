...
class MiDomainTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp()
  {
    ...
    $this->dbName = MegaIndexConfig::$testDbName;

    $this->db->createNewDb(MegaIndexConfig::$testDbName, MegaIndexConfig::$dbDriver, MegaIndexConfig::$dbHost, MegaIndexConfig::$dbLogin, MegaIndexConfig::$dbPassword);
